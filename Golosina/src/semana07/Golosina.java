...
public class Golosina extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		if (marca==0){pre=9.0;}
		else if (marca==1){pre=7.4;}
		else if (marca==2){pre=8.6;}
		else {pre=10.6;}
		...
		txtS.setText("**REPORTE DEL PROGRAMA DE GOLOSINA** \n\n");
		imprimo("el importe de compra es      :" + decimalFormat(impC)+"\n");
		imprimo("el importe de descuento es   :" + decimalFormat(impD)+"\n");
		imprimo("el importe a pagar es        :" + decimalFormat (impP)+"\n");
		imprimo("CANTIDAD DE OBSEQUIO         :" + (caramelo));
